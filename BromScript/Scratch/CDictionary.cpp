...
template<class TKey, class TValue>
int CDictionary<TKey, TValue>::IndexByKey(const TKey &key) {
...
template<class TKey, class TValue>
int CDictionary<TKey, TValue>::IndexByValue(const TValue &value) {
	int ctElements = Count();
...
template<class TKey, class TValue>
void CDictionary<TKey, TValue>::RemoveByIndex(const int iIndex) {
...
template<class TKey, class TValue>
int CDictionary<TKey, TValue>::Count(void) {
...
template<class TKey, class TValue>
TValue& CDictionary<TKey, TValue>::GetValueByIndex(const int iIndex) {
	// return the value
	return dic_saValues[iIndex];
}
...
template<class TKey, class TValue>
TKey& CDictionary<TKey, TValue>::GetKeyByIndex(const int iIndex) {
	// return the value
